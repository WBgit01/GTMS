...
<div class="main_content">
    ...
    <div class="panel_container">
        ...
        <form class="account" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="account_edit">
                <div class="input_container">
                    ...
                    <input type="text" placeholder="Firstname" value = "<?php echo $_SESSION['firstname']?>" disabled>
                </div>
            </div>
